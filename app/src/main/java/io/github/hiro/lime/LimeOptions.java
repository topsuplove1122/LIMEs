...
public class LimeOptions {
    ...
    public enum OptionCategory {
        ...
        public Option removeVoom = new Option("remove_voom", R.string.switch_remove_voom, false, OptionCategory.GENERAL);
        public Option removeWallet = new Option("remove_wallet", R.string.switch_remove_wallet, false, OptionCategory.GENERAL);
        public Option removeNewsOrCall = new Option("remove_news_or_call", R.string.switch_remove_news_or_call, false, OptionCategory.GENERAL);
        public Option distributeEvenly = new Option("distribute_evenly", R.string.switch_distribute_evenly, false, OptionCategory.GENERAL);
        public Option extendClickableArea = new Option("extend_clickable_area", R.string.switch_extend_clickable_area, false, OptionCategory.GENERAL);
        public Option removeIconLabels = new Option("remove_icon_labels", R.string.switch_remove_icon_labels, false, OptionCategory.GENERAL);
        ...
        public Option removeRecommendation = new Option("remove_recommendation", R.string.switch_remove_recommendation, false, OptionCategory.Ad);
        public Option removePremiumRecommendation = new Option("remove_premium_recommendation", R.string.switch_remove_premium_recommendation, false, OptionCategory.Ad);
        ...
        public Option preventUnsendMessage = new Option("prevent_unsend_message", R.string.switch_prevent_unsend_message, true, OptionCategory.CHAT);
        ...
        public Option Archived = new Option("Archived_message", R.string.switch_archived, true, OptionCategory.CHAT);
        ...
        public Option BlockCheck = new Option("BlockCheck", R.string.BlockCheck, false, OptionCategory.CHAT);
        ...
        public Option removeReplyMute = new Option("remove_reply_mute", R.string.switch_remove_reply_mute, false, OptionCategory.NOTIFICATIONS);
    ...
    public Option DarkColor = new Option("DarkColor", R.string.DarkColor, false, OptionCategory.Theme);
        public Option DarkModSync = new Option("DarkModSync", R.string.DarkkModSync, false, OptionCategory.Theme);
    ...
    public Option RemoveVoiceRecord = new Option("RemoveVoiceRecord", R.string.RemoveVoiceRecord, false, OptionCategory.CHAT);
        public Option CallOpenApplication = new Option("CallOpenApplication", R.string.CallOpenApplication, false, OptionCategory.CALL);
        public Option SettingClick = new Option("SettingClick", R.string.SettingClick, false, OptionCategory.OTHER);
        public Option photoboothButtonOption = new Option("photoboothButtonOption", R.string.photoboothButtonOption, false, OptionCategory.CHAT);
        public Option voiceButtonOption = new Option("voiceButtonOption", R.string.voiceButtonOption, false, OptionCategory.CHAT);
        public Option videoButtonOption = new Option("videoButtonOption", R.string.videoButtonOption, false, OptionCategory.CHAT);
        public Option videoSingleButtonOption = new Option("videoSingleButtonOption", R.string.videoSingleButtonOption, false, OptionCategory.CHAT);
